...
last part of the lm-model is testing for random effects (if the data acquired is not fully representative for the whole data); including the random effects term is like conducting a meta-analysis
