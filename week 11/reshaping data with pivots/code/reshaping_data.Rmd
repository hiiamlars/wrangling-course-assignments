...
#data_long <- data_wide_likert %>%
#  pivot_longer(cols = -id, #negative selection
#               names_to = "item",
...
#loading the dataset
data_dem_raw <- read.csv("C:/Users/Lars/Desktop/GitHub/wrangling-course-assignments/week 11/reshaping data with pivots/data/raw/data_demographics_raw.csv")

#pivoting the response column into the separate columns of age and gender in correspondence of the entry in the column trialcode
